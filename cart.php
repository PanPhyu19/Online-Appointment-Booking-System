...
if(isset($_POST['update_update_btn'])){
   ...
   $update_quantity_query = mysqli_query($connection, "UPDATE cart SET quantity = '$update_value' WHERE cartid = '$update_id'");
...
if(isset($_GET['remove'])){
   ...
   mysqli_query($connection, "DELETE FROM cart WHERE cartid = '$remove_id'");
   header('location:cart.php');
};
